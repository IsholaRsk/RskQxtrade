...
- 🤖 **AUTOBOT SNIPER 100 % cloud** : trade ton compte **MT5 classique (Pocket Option MT5 inclus)** tout seul — MetaAPI + cron gratuit. **4 marchés (XAUUSD · NAS100 · GBPUSD · BTCUSD) analysés en continu**, killzone New York 14h-20h Paris, setups sniper uniquement (sweep → CHoCH/BOS → OB+FVG, ≥4★, flux M15 aligné, R:R ≥ 1:2), risque 1 %, max 4 trades/jour, 2 simultanés, stop 2 pertes, breakeven +1R, DRY-RUN sûr par défaut → **[AUTOBOT_SETUP.md](AUTOBOT_SETUP.md)**
